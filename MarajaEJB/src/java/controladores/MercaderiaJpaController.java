...
public class MercaderiaJpaController implements Serializable {
    ...
    public MercaderiaJpaController(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
    ...
    public void create(Mercaderia mercaderia) throws RollbackFailureException, Exception {
    ...
    public void edit(Mercaderia mercaderia) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
