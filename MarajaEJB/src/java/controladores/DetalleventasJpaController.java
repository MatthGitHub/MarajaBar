...
public class DetalleventasJpaController implements Serializable {
    ...
    public DetalleventasJpaController(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
    ...
    public void create(Detalleventas detalleventas) throws PreexistingEntityException, RollbackFailureException, Exception {
    ...
    public void edit(Detalleventas detalleventas) throws NonexistentEntityException, RollbackFailureException, Exception {
        detalleventas.getDetalleventasPK().setFkVenta(detalleventas.getVentas().getIdVenta());
        detalleventas.getDetalleventasPK().setFkProducto(detalleventas.getProductos().getIdProducto());
        EntityManager em = null;
        try {
    ...
    public void destroy(DetalleventasPK id) throws NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
