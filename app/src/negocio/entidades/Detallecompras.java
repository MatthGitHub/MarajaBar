...
public class Detallecompras implements Serializable {
    ...
    @JoinColumn(name = "fkMerca", referencedColumnName = "idProducto", insertable = false, updatable = false)
    @ManyToOne(optional = false)
    ...
    public String toString() {
        return "negocio.entidades.Detallecompras[ detallecomprasPK=" + detallecomprasPK + " ]";
    }
